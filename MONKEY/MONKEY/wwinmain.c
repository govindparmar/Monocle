...
INT APIENTRY wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPWSTR lpCmdLine, INT nShowCmd)
{
	...
	hThread[0] = CreateThread(NULL, 0, (LPTHREAD_START_ROUTINE)&TimerWrapThread, (LPVOID)&hInstance, 0, NULL);
	hThread[1] = CreateThread(NULL, 0, (LPTHREAD_START_ROUTINE)&UserDirectoryWatchThread, (LPVOID)&wdi, 0, NULL);
